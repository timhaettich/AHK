...
do(funct,p1,p2){ ; execAFunc does not support varadic functions or optional params
    ...
    ;msgbox % p1 "`n" p2 "`n" p3 "`n" stringify(params)
...
class fileList {
    ...
    genList(){
        ...
        loop,parse,allScripts,`n
        {
            ...
            ; expand paths
            ;if(subStr(t.3,1,11)="a_scriptDir")
            ;    t.3:=strReplace(t.3,"a_scriptDir",a_scriptDir)
            if(!ctn){
...
;        msgbox % "var: " . pauseState . "`nfunc: " . this.pauseState()
